...
def calc_propensities(model, use_dict=True):
    ...
    propensity_E_d_to_E_d = model.memberships[STATES.E_d] * (1.0
    ...
    # state J_ds
    propensity_J_ds_to_R_d = model.memberships[STATES.J_ds] * model.gamma_Id
    propensity_J_ds_to_D_d = model.memberships[STATES.J_ds] * model.mu
    propensity_J_ds_to_J_ds = model.memberships[STATES.J_ds] * (
        1.0 - propensity_J_ds_to_R_d - propensity_J_ds_to_D_d)

    # state J_dn
    propensity_J_dn_to_R_d = model.memberships[STATES.J_dn] * model.gamma_Id
